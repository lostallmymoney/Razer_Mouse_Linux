...
Want support for another device? Just [add the files](https://github.com/lostallmymoney/Razer_Mouse_Linux/issues/55) or [contact me](https://github.com/lostallmymoney/Razer_Mouse_Linux/discussions) and configure with ```naga vendor```.  
