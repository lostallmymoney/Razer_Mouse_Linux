...
&& echo "\nAuto-generated example for devices.emplace_back:" \
&& echo "devices.emplace_back(\"/dev/input/by-id/$kbd\", \"/dev/input/by-id/$mouse\");" \
&& echo "\nOpen either src/nagaX11.cpp or src/nagaWayland.cpp in an editor (in Razer_Mouse_Linux-log-events)." \
