...
#define ONKEYRELEASED false
		...
		configKeysMap.insert(stringAndConfigKey("xdotoolType", new configKey(ONKEYPRESSED, executeNow, "setsid xdotool type --window getactivewindow ")));
		configKeysMap.insert(stringAndConfigKey("xdotoolTypeRelease", new configKey(ONKEYRELEASED, executeNow, "setsid xdotool type --window getactivewindow ")));
